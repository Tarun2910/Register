export const portfolioData = {
  portfolio: {
    all: [
      {
        id: 1,
        srcImg: '/assets/images/extra-pages/portfolio/omnilearn.png',
        title: 'Omnilearn Pro',
        subTitle: 'Product',
        key: true,
      },
      {
        id: 2,
        srcImg: '/assets/images/extra-pages/portfolio/teamsync1.png',
        title: 'Teamsync',
        subTitle: 'Product',
        key: true,
      },
      {
        id: 3,
        srcImg: '/assets/images/extra-pages/portfolio/crm.png',
        title: 'Crm',
        subTitle: 'Product',
        key: true,
      },
      // {
      //   id: 3,
      //   srcImg: '/assets/images/extra-pages/portfolio/claros.png',
      //   title: 'Claros',
      //   subTitle: 'Product',
      //   key: true,
      // },
