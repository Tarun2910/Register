...
const CourseCell = ({course, thumbnailUrls}) => {
  ...
  const handleGoToPlayList = () => {
    navigate('/ecommerce/product_detail/' + course.id);
  };
  ...
  const formattedEndDate = formatDate(course.activeEndDate);
  const formattedStartDate = formatDate(course.activeStartDate);
